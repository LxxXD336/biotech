...
const EVENTS: EventItem[] = [
    { month: "MAY", day: "10", title: "Registration opens",subtitle: "Registration opens for all participants.", color: "#333333" },
    { month: "JUL", day: "8", title: "Registration close", subtitle: "Registration closes for all participants.", color: "#BDE8B6" },
    { month: "AUG", day: "5", title: "Project commence", subtitle: "Project commence, get ready!", color: "#BDE8B6" },
    { month: "SEP", day: "12", title: "Project Submission due", subtitle: "Project submission due, no extension is allowed.", color: "#BDE8B6" },
    { month: "OCT", day: "9", title: "Presentation & Symposium", subtitle: "Presentation & Symposium, get ready!", color: "#D9D9D9" },
];
                ...
                <div ref={wrapRef} className={`te2-wrap ${inView ? "te2-inview" : ""}`}>
                    ...
                    >
                        ...
                        >
                            <Editable 
                                id="timeline.title" 
                                defaultText="KEY QLD DATES 2025"
                                satelliteType="queensland"
                            />
                        </motion.h2>
                    </motion.header>
