...
describe('VictoriaSatellite Timeline Component', () => {
  beforeEach(() => {
    render(<Timeline />);
  });
  ...
  it('displays the main timeline heading', () => {
    expect(screen.getByText('KEY VIC DATES 2022')).toBeInTheDocument();
  });
  ...
  it('displays title with correct styling', () => {
    const title = screen.getByText('KEY VIC DATES 2022');
  ...
  it('has correct Victoria-specific content', () => {
    expect(screen.getByText('KEY VIC DATES 2022')).toBeInTheDocument();
    expect(screen.getByText('KEY DATES')).toBeInTheDocument();
  });
