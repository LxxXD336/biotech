...
const EVENTS: EventItem[] = [
    { month: "MAY", day: "22", title: "Registration opens",subtitle: "Registration opens for all participants.", color: "#333333" },
    { month: "JUL", day: "17", title: "Registration close", subtitle: "Registration closes for all participants.", color: "#BDE8B6" },
    { month: "JUL", day: "31", title: "Project commence", subtitle: "Project commence, get ready!", color: "#D9D9D9" },
    { month: "AUG", day: "25", title: "Project Submission due", subtitle: "Project submission due, no extension is allowed.", color: "#D9D9D9" },
    { month: "SEP", day: "8", title: "Presentation & Symposium", subtitle: "Presentation & Symposium, get ready!", color: "#D9D9D9" },
];
...
export default function Timeline(){
    ...
    const calculateTimePointPositions = () => {
        const positions = nodeRefs.current.map((nodeRef, index) => {
            if (nodeRef && wrapRef.current) {
                ...
                const y = nodeRect.top - containerRect.top + nodeRect.height / 2 - (isMobile ? 110 : 160); // 手机端向下移动
    ...
    // 改进的 toggle：关闭时 blur 当前按钮，切换时 blur 之前按钮
    ...
    return (
        <section id="timeline-enhanced-v2" ref={sectionRef} aria-label="Key dates timeline">
                ...
                <div ref={wrapRef} className={`te2-wrap ${inView ? "te2-inview" : ""}`}>
                    ...
                    >
                        ...
                        >
                            <Editable 
                                id="timeline.title" 
                                defaultText="KEY VIC DATES 2022"
                                satelliteType="victoria"
                            />
                        </motion.h2>
                    </motion.header>
            ...
            <style>{`
/* 基础布局 & 颜色 */
#timeline-enhanced-v2 { color: ${COLORS.charcoal}; background: transparent; }
.te2-wrap { max-width: 1200px; margin: auto;margin-bottom: -60px;margin-top: -20px;}
...
.te2-title { margin: 10px 0; font-size: clamp(32px,4.6vw,64px); font-weight:900; color:#017151}
...
.te2-sub { margin-top:6px; color: ${COLORS.charcoal}; opacity:0.8; font-size:22px }
