...
import Timeline from "./sections/QueenslandSatellite/Timeline";
import Hero from "./sections/QueenslandSatellite/Hero";

import About from "./sections/QueenslandSatellite/About";
import Intro from "./sections/QueenslandSatellite/Intro";
import Mentor from "./sections/QueenslandSatellite/Mentor";
import Video from "./sections/QueenslandSatellite/Video";
import Contact from "./sections/QueenslandSatellite/Contact";
...
export default function QueenslandSatellite() {
    return (
        <main style={{ background: "transparent", color: COLORS.charcoal, position: "relative" }}>
            ...
            <SatelliteAdminPanel satelliteType="queensland" />
        </main>
    );
}